...
$('#arrow-down').click(function(){
	 ...
	 if ($(window).scrollTop() <= $('.work-banner').offset().top - 70 && $(window).scrollTop() >= $('.about-section').offset().top + 70) {
		 $('html, body').animate({
...
$('#arrow-up').click(function(){
	 if ($(window).scrollTop() >= $('.work-banner').offset().top - 70 && $(window).scrollTop() < $('.about-section').offset().top - 100) {
		 $('html, body').animate({
	        scrollTop: 0
	    });
	    return;
...
/*
	  if ($(window).scrollTop() >= $('.about-section').offset().top - 100 && $(window).scrollTop() < $('.thoughts-container').offset().top - 70) {
		 $('html, body').animate({
...
*/
	 ...
	 if ($(window).scrollTop() >= $('.about-section').offset().top + 70) {
		 $('html, body').animate({
		 	scrollTop: $('.work-banner').offset().top - 70
	    });
	     $(".arrow-down").css( 'opacity', '1' );
